...
func init() {
	sdk.TxCdc.RegisterInterface((*sdk.TxInner)(nil), nil)
	sdk.TxCdc.RegisterConcrete(TxTransferFundPropose{}, TypeTxTransferFundPropose, nil)
	sdk.TxCdc.RegisterConcrete(TxChangeParamPropose{}, TypeTxChangeParamPropose, nil)
	sdk.TxCdc.RegisterConcrete(TxDeployLibEniPropose{}, TypeTxDeployLibEniPropose, nil)
	sdk.TxCdc.RegisterConcrete(TxRetireProgramPropose{}, TypeTxRetireProgramPropose, nil)
	sdk.TxCdc.RegisterConcrete(TxUpgradeProgramPropose{}, TypeTxUpgradeProgramPropose, nil)
	sdk.TxCdc.RegisterConcrete(TxVote{}, TypeTxVote, nil)
}
