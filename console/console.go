...
func (c *Console) init(preload []string) error {
	...
	if err := c.jsre.Compile("web3-ec.js", jsre.Web3_JS); err != nil {
		return fmt.Errorf("web3-ec.js: %v", err)
	}
	if _, err := c.jsre.Run("var Web3 = require('web3-ec');"); err != nil {
		return fmt.Errorf("web3-ec require: %v", err)
	}
	...
	flatten := "var ec = web3.ec; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
func (c *Console) Welcome() {
	...
	c.jsre.Run(`
		...
		console.log("coinbase: " + ec.coinbase);
		console.log("at block: " + ec.blockNumber + " (" + new Date(1000 * ec.getBlock(ec.blockNumber).timestamp) + ")");
